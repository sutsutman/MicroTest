...
namespace Micro
{
    ...
    public class Mincho_Dodge : Verb
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            if (casterPawn == null || reloadableCompSource == null || !reloadableCompSource.CanBeUsed)// was cut out
                return false;
        ...
        public override void OrderForceTarget(LocalTargetInfo target)
        {
            ...
            //CasterPawn.stances.SetStance((Stance)new Stance_Mobile());is also a choice
            ...
            //this should be the code I was missing
            this.CasterPawn.jobs.EndCurrentJob(JobCondition.InterruptForced);
